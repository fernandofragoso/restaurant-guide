  ...
  render() {
    return (
      <div className="Filter"> 
        ...
        <section className="Filter__section">
          <ul>
            <li><input name="1" onChange={(e) => this.handleChange(e, 'costs')} type="checkbox"/> Até $50</li>
            <li><input name="2" onChange={(e) => this.handleChange(e, 'costs')} type="checkbox"/> De $50 a $80</li>
            <li><input name="3" onChange={(e) => this.handleChange(e, 'costs')} type="checkbox"/> De $80 a $110</li>
            <li><input name="4" onChange={(e) => this.handleChange(e, 'costs')} type="checkbox"/> Acima de $110</li>
          </ul>
        </section>
